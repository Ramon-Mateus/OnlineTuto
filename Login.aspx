<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="CRUD.Login" %>
...
<body>
    ...
    <div class="form-group">
        <asp:Panel ID="Panel7" runat="server" CssClass="form-group">
            ...
            <asp:TextBox ID="usernameBox" runat="server" TextMode="Password" Cssclass="form-control"></asp:TextBox>
        </asp:Panel>
