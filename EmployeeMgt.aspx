<%@ Page Title="" Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site.Master" CodeBehind="EmployeeMgt.aspx.vb" Inherits="CRUD.EmployeeMgt" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <div class="form-group">
            <br />
            <asp:Button ID="UpdateBtn" runat="server" Text="Update" CssClass="btn btn-warning" />
